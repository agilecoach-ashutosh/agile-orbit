(function(){
  document.addEventListener('DOMContentLoaded',function(){
    ...
    const scenes=[
      ...
      {n:'03',label:'PRACTICE',eyebrow:'02 · PRACTICE',title:['Turn Knowledge','into Action.'],lead:'Test your judgement with practice questions, real scenarios and hands-on exercises.',cta:'Start Practicing',href:'practice/',chips:['452 Questions','Exam Mode','Scenarios','Feedback'],orbit:'PRACTICE BUILDS CONFIDENCE'},
